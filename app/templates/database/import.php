...
// post
if ($_POST) {
    $content = $admin->import($db, $_FILES['import_file']['tmp_name'], $_POST['charset_of_file']);
    var_dump($content);
}
?>
<h2>Exportiere Datensätze in Tabelle "<?= $db ?>"</h2>
<!-- ERROR -->
    ...
    <div class="importoptions">
        ...
        <div class="formelementrow" id="compression_info">
            <p>
                ...
                Die CSV-Datei wird Zeilenweise gelesen und in die Datenbank importiert. Fehlende Felder werden leer
                gelassen.
            </p>
        </div>
